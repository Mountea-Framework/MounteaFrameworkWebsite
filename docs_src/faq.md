...
**Core Plugins** (install into your project’s `Plugins/` folder):
...
Most core plugins support **UE 4.26 through UE 5.2**. For exact compatibility and version-specific branches, see the **Releases** or **README** of each plugin’s GitHub page.
...
[https://github.com/Mountea-Framework/Examples](https://github.com/Mountea-Framework/Examples)

## Where can I get support or report issues?

- **Discord**: [https://discord.com/invite/G66XvQTv3E](https://discord.com/invite/G66XvQTv3E)
